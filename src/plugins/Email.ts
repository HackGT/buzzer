...
export class EmailPlugin implements Plugin<EmailConfig> {
  ...
  constructor() {
    ...
    this.headerImage = process.env.EMAIL_HEADER_IMAGE || "";
    this.twitterHandle = process.env.EMAIL_TWITTER_HANDLE || "";
    this.facebookHandle = process.env.EMAIL_FACEBOOK_HANDLE || "";
    this.contactAddress = process.env.EMAIL_CONTACT_ADDRESS || "";
